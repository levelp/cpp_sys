...
#define  PANEL_COM_READ_FROM              2       /* control type: ring, callback function: (none) */
#define  PANEL_COM_SEND_TO                3       /* control type: ring, callback function: (none) */
#define  PANEL_STRIPCHART                 4       /* control type: strip, callback function: (none) */
#define  PANEL_TIMER                      5       /* control type: timer, callback function: cbTimerTick */
